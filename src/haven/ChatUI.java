...
public class ChatUI extends Widget {
    public static final Resource alarmsfx = Resource.local().loadwait("sfx/chatalarm");
    	...
    	public void uimsg(String msg, Object... args) {
            ...
            if (name.equals(Resource.getLocString(Resource.BUNDLE_LABEL, "Area Chat")) && line.startsWith(CMD_PREFIX_HLIGHT)) {
                try {
                    ...
                    // if (gob != null) {
                    //     gob.delattr(GobHighlight.class); //might be issue
    ...
    private static final Resource notifsfx = Resource.local().loadwait("sfx/chatalarm");//hud/chat");
