...
public class UpdateWnd extends Window {
    private static final String dwnurl = "https://github.com/isoisoy/Slush/releases/download/";
    ...
    public UpdateWnd(final String version) {
        ...
        Button btn = new Button(200, "Download Update") {
            public void click() {
                ...
                if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
                    try {
                        desktop.browse(new URI(dwnurl + version + "/slush-" + version + "-upd.zip"));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
        ...
        pack();
        this.c = new Coord(JOGLPanel.lshape.sz().x / 2 - sz.x / 2, JOGLPanel.lshape.sz().y / 2 - sz.y / 2);
    }
