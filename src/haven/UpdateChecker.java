...
public class UpdateChecker extends Thread {
    private static final String url = "https://api.github.com/repos/isoisoy2/Slursh/releases/latest";
    ...
    public void run() {
        try {
            ...
            if (isnewer(Config.version, latestver) && JOGLPanel.lui != null && JOGLPanel.lui.root != null) {
                Window updwnd = new UpdateWnd(latestver);
                JOGLPanel.lui.root.add(updwnd);
                updwnd.show();
                updwnd.raise();
            }
        } catch (Exception e) {
